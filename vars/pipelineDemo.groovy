...
def call(def body = [:]) {
  ...
  def imageStepConform = 'controlplane/build-step-conform:latest'
  def imageStepHadolint = 'controlplane/build-step-hadolint:latest'
  def imageStepGitSecrets = 'controlplane/build-step-git-secrets:latest'
